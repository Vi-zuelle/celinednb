...
#User seeds
vi = User.create!(first_name: "Vi", last_name: "Pannetier", username: "vi", email: "vi@cdnb.com", password:"123456", avatar:"https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/ou4lgsqy6jbsls2a4ofh.jpg")
...
quan = User.create!(first_name: "Quan", last_name: "Nguyen", username: "Quanito1337", email: "quan@cdnb.com", password:"123456", avatar:"https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/nckgybiierpms4czk2vk.jpg")
costin = User.create!(first_name: "Costin", last_name: "Dumi", username: "Costin123", email: "costin@cdnb.com", password:"123456", avatar:"https://avatars1.githubusercontent.com/u/53879882?v=4")
gi = User.create!(first_name: "gi", last_name: "Vannetier", username: "giii", email: "gi@cdnb.com", password:"123456")

#Céline Seeds
chris_celineTitanic = Celineversion.create!(name: "Céline Titanic", description: "Always looking to find the heart that went on before killing DiCaprio with cold blood. She is always screems at night after her lost heart. The heart will always go on, Amen!", price: 1200, image: "https://i.ytimg.com/vi/EcU0qbV70rU/maxresdefault.jpg", user: chris)
...
quan_celineHaunted = Celineversion.create!(name: "Céline on Demon Speed", description: "The Demon is in me. looking for a road to ride on. That is after she gave her soul to the DEVIL.", price: 9000, image: "https://img.buzzfeed.com/buzzfeed-static/static/2018-12/13/12/campaign_images/buzzfeed-prod-web-04/16-reasons-celine-dion-is-possessed-by-satan-demo-2-4549-1544721916-1_dblbig.jpg", user: quan)
...
vi_celineDesert = Celineversion.create!(name: "Sensual In The Desert", description: "Bringing warm weather with me. Be cool,but don't be cold. Let me heat you with my beauty and put you in bed with my voice.", price: 7000, image: "https://images.radio-canada.ca/q_auto,w_1250/v1/ici-info/16x9/celine-dion-desert-nouvel-album-courage.PNG", user: vi)
...
quan_celineScary = Celineversion.create!(name: "Queen Of White-Crows", description: "My beauty is not something to be joked with, but men are pigs, therefore I decided to orientate towards birds and I chose crows (inspired from Game of Thrones), but white crows.", price: 99000, image: "https://static.standard.co.uk/s3fs-public/thumbnails/image/2019/05/06/20/celinedion-metgala-2019.jpg", user: quan)
...
chris_celineQueen = Celineversion.create!(name: "Queen Of England", description: "Mate, are you looking for your queen? Well, I am here waiting to meet you in your flat. Just let me put on my jumper.", price: 1200, image: "https://img.buzzfeed.com/buzzfeed-static/static/2019-11/14/17/campaign_images/5a4608f5d9ec/i-cant-stop-watching-celine-dions-response-to-bei-2-1349-1573751962-0_dblbig.jpg", user: chris)
vi_celineDPool = Celineversion.create!(name: "Céline & BF Deadpool", description: "Want to hear a joke? Well, my new boyfiend has tons in his agenda, so just hit us up! ", price: 3200, image: "https://www.dravenstales.ch/wp-content/uploads/2018/05/celine-dion-deadpool.jpg", user: vi)
